    ...
    <div class="footer-content">
                ...
                <div class="newsletter-content">
                    <div class="newsletter-header">
                        ...
                        <div class="newsletter-text">
                            ...
                            <p class="newsletter-subtitle">Dapatkan berita terkini langsung ke email Anda</p>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-wrapper">
                <p class="copyright-text">&copy; {{ date('Y') }} FOKUS KITO. ALL RIGHTS RESERVED.</p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        scrollTopBtn.innerHTML =
            '<svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>';
